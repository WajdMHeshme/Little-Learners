...
import icon from "/assets/Iconm.svg";
...
import history from "/assets/Abstract Design (6).png";
import student1 from "/assets/Image (7).png";
import student2 from "/assets/Image (8).png";
import student3 from "/assets/Image (9).png";
import student4 from "/assets/Image (10).png";
import student5 from "/assets/Image (11).png";
import student6 from "/assets/Image (12).png";
import imgGallery1 from "/assets/Image (13).png";
import imgGallery2 from "/assets/Image (14).png";
import imgGallery3 from "/assets/Image (15).png";
import imgGallery4 from "/assets/Image (16).png";
import imgGallery5 from "/assets/Image (17).png";
import imgGallery6 from "/assets/Image (29).png";
import imgGallery7 from "/assets/Image (30).png";
import imgGallery8 from "/assets/Image (31).png";
import imgGallery9 from "/assets/Image (18).png";
import imgGallery10 from "/assets/Image (19).png";
import imgGallery11 from "/assets/Image (20).png";
import imgGallery12 from "/assets/Image (32).png";
import imgGallery13 from "/assets/Image (34).png";
import imgGallery14 from "/assets/Image (35).png";
import imgGallery15 from "/assets/Image (36).png";
import imgGallery16 from "/assets/Image (37).png";
import imgGallery17 from "/assets/Image (25).png";
import imgGallery18 from "/assets/Image (26).png";
import imgGallery19 from "/assets/Image (27).png";
import imgGallery20 from "/assets/Image (28).png";
...
import img3 from '/assets/Image (40).png'
import img4 from '/assets/Image (41).png'
import img5 from '/assets/Image (42).png'
import img6 from '/assets/Image (44).png'
...
export const AdmissionProcCardsData = [
  {
    num: "01",
    title: "Inquiry",
    pgf: "Submit an inquiry form through our website or contact our admissions office to express your interest in Little Learners Academy.",
  },
  {
    num: "02",
    title: "School Tour",
    pgf: "Schedule a personalized school tour to explore our campus, meet our staff, and gain insights into our nurturing learning environment.",
  },
  {
    num: "03",
    title: "Application Form",
    pgf: "Complete the application form and provide the required documents, including your childs birth certificate, medical records, and any previous academic records (if applicable).",
  },
  {
    num: "04",
    title: "Parent Interview",
    pgf: "We value parent engagement, and a meeting with our admissions team allows us to understand your childs needs and ensure Little Learners Academy aligns with your familys expectations.",
  },
  {
    num: "05",
    title: "Student Assessment",
    pgf: "For certain age groups, a student assessment may be conducted to understand their developmental progress and ensure the best placement.",
  },
  {
    num: "06",
    title: "Acceptance",
    pgf: "Once the admission process is complete, you will receive an official acceptance letter from Little Learners Academy.",
  },
];
export const CardDataStudents = [
  {
    icon: <MdSportsTennis />,
...
export const EventsCardData = [
  {
    ...
    pgf: "A day filled with friendly competition, team spirit, and sportsmanship.",
  },
  {
    img: img1,
    title: "Cultural Festivals",
    pgf: "Celebrations of diverse cultural festivals, promoting cultural exchange and appreciation.",
  },
  {
    img: img3,
    title: "Art Exhibitions",
    pgf: "Showcasing our students' artistic talents through exhibitions and displays.",
  },
  {
    img: img4,
    title: "Science Fair",
    pgf: "A platform for budding scientists to present their innovative projects and experiments.",
  },
  {
    img: img5,
    title: "International Day",
    pgf: "A vibrant celebration of our diverse community, embracing cultures from around the world.",
  },
  {
    img: img6,
    title: "Graduation Ceremony",
    pgf: "A significant milestone as our Kindergarten students prepare to embark on their academic journey.",
  },
];
